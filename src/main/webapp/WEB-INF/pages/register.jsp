		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form action="saveUser" method="post">
					...
					<fieldset class="form-group">
						<span><label class="control-label" for="name"> Name</label>
							<input class="form-control col-md-4" type="text" name="name"
							id="name" placeholder="Enter Name" required="required" /> </span>
					</fieldset>
					<div name="emailError" id="emailError">
						<label style="font-style: italic; color: red;"
							id="emailErrorLabel"></label>
					</div>
					<fieldset class="form-group">
						<span><label class="control-label" for="email">Email
							...
							onkeyup="validateEmail(this.value)" required="required" /> </span>
					</fieldset>
					<fieldset class="form-group">
						<span><label class="control-label" for="password">Password</label>
							<input class="form-control col-md-4" type="password"
							name="password" id="password" placeholder="Enter Password"
							onkeyup="confirmPassword('password')" required="required" /> </span>
					</fieldset>
					<fieldset class="form-group">
